...
export default function LobbyFlow({
  ...
  const prevStep = () => {
    if (currentStep === 1) {
      navigate(-1); // Go back to Home / Game Selection if on first step
    } else {
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                >
                  ...
                  <span className="relative z-10 flex items-center justify-center group-hover:text-black transition-colors duration-300">Continue &rarr;</span>
                </button>
              </div>
            </motion.div>
          )}
